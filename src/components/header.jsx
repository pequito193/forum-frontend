        ...
        <React.Fragment>
            <div className="header">
                <div className="left-header">
                    <Link to={'/forum-frontend/'}><img className="logo" src={require('./../assets/logo.png')} alt="logo" /></Link>
                ...
                <div className="header-wrapper">
                    <Link to={'/forum-frontend/user'} className="username">{username}</Link>
                    <Link to={'/forum-frontend/user'} className="links"><img className="settings" src={require('./../assets/settings.png')} alt="settings" /></Link>
                </div>
            </div>
